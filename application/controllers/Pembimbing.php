...
class Pembimbing extends CI_Controller
{
	...
	public function save()
	{
		...
		$this->form_validation->set_rules('nama_dosen', 'Nama Pembimbing', 'required|trim|min_length[3]|max_length[50]');
		$this->form_validation->set_rules('email', 'Email', 'required|trim|valid_email' . $u_email);
		$this->form_validation->set_rules('matkul', 'Mata Pelajaran', 'required');
