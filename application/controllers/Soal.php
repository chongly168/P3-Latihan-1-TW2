...
class Soal extends CI_Controller {
	...
	public function __construct(){
		...
		if (!$this->ion_auth->logged_in()){
			redirect('auth');
		}else if ( !$this->ion_auth->is_admin() && !$this->ion_auth->in_group('pembimbing') ){
			show_error('Hanya Administrator dan pembimbing yang diberi hak untuk mengakses halaman ini, <a href="'.base_url('dashboard').'">Kembali ke menu awal</a>', 403, 'Akses Terlarang');
		}
