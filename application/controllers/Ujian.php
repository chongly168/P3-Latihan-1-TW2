...
class Ujian extends CI_Controller {
    ...
    {
        if ( !$this->ion_auth->in_group('pembimbing') ){
			show_error('Halaman ini khusus untuk pembimbing untuk membuat Online Test, <a href="'.base_url('dashboard').'">Kembali ke menu awal</a>', 403, 'Akses Terlarang');
		}
    }
