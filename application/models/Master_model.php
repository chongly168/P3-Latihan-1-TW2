...
class Master_model extends CI_Model {
    ...
    public function getKelasbyMatkul($id)
    {
        $this->db->select('id_kelas, nama_kelas, nama_jurusan');
        $this->db->from('kelas a');
        $this->db->join('jurusan_matkul b', 'b.jurusan_id = a.jurusan_id');
        $this->db->join('jurusan c', 'c.id_jurusan = a.jurusan_id');
        $this->db->join('dosen d', 'd.matkul_id = b.matkul_id');
        $this->db->where('d.id_dosen', $id);
