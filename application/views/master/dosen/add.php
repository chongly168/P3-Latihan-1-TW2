<?=form_open('pembimbing/save', array('id'=>'formdosen'), array('method'=>'add'));?>
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Form <?=$subjudul?></h3>
        <div class="box-tools pull-right">
            <a href="<?=base_url()?>pembimbing" class="btn btn-sm btn-flat btn-warning">
        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nama_dosen" placeholder="Nama Pembimbing">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
