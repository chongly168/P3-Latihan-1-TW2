...
class MYPDF extends TCPDF {
    ...
    public function Header() {  
        $image_file = K_PATH_IMAGES.'seamolec.png';
        $this->Image($image_file, 10, 10, 15, '', 'PNG', '', 'T', false, 400, '', false, false, 0, false, false, false);
        $this->SetFont('helvetica', 'B', 14);
        $this->SetY(7);
        $this->Cell(0, 15, 'ONLINE TEST', 0, false, 'C', 0, '', 0, false, 'M', 'M');
        $this->SetY(13);
        $this->Cell(0, 15, 'SEAMEO SEAMOLEC', 0, false, 'C', 0, '', 0, false, 'M', 'M');
        $this->SetY(19);
        $this->Cell(0, 15, 'HASIL UJIAN PEMAGANGAN', 0, false, 'C', 0, '', 0, false, 'M', 'M');
    }
...
<table>
    ...
    <tr>
        ...
        <h2>Daftar Hasil Ujian Calon Peserta Magang SEAMEO SEAMOLEC</h2>
        <br>
        </td>
    </tr>
    <tr>
