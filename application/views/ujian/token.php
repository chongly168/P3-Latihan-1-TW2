<div class="callout callout-info">
    ...
    <p>1. Peserta melakukan login pada aplikasi CBT menggunakan username dan  password yang telah dibagikan.</p>
    <p>2. Peserta memasukkan "Token" yang diumumkan oleh Pembimbingnya. </p>
    <p>3. Menjawab butir soal dapat dilakukan dengan cara: </p>
    <p>   -memilih/mengklik option jawaban menggunakan mouse atau. </p>
    <p>   -menekan keyboard (huruf A atau B atau C atau D atau E). </p>
    <p>4. Peserta dapat mengubah option jawaban dengan cara memilih/mengklik option jawaban lain yang dianggap benar. Jawaban peserta otomatis akan terganti dengan pilihan    jawaban yang terakhir. </p>
    <p>5. Memastikan mengklik tombol selesai di soal terakhir jika ingin mengakhiri tes sebelum waktu tes selesai. </p>
    <p>6. Peserta dapat langsung melihat hasil ujian setelah selasai ujian.</p>
                ...
                <div class="box box-solid">
                    <div class="box-body pb-0">
                        ...
                        <div class="callout callout-danger">
                            ...
                            Silahkan hubungi pembimbing anda untuk bisa mengikuti ujian pengganti.
                        </div>
                        <?php endif;?>
                    </div>
                </div>
